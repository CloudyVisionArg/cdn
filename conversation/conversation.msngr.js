...
function getMessengerDataProvider(opts){
	messengerProvider = new messengerDataProvider(opts);
	return messengerProvider;
}

function messengerDataProvider(opts){
    this.parent = conversationBaseDataProvider;
	this.parent();
    this.supportedTypes = ["messengerMsg"];
    ...
    var setupRequiredInfo = function () {
        return new Promise((resolve,reject)=>{
            ...
            DoorsAPI.foldersGetByPath(me.rootFolder, '/messenger/chats').then(
                function (fld) {
