		...
		<div class="conversation-providers-status-bar">
			...
			<div class="conversation-status">
				...
				<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					...
					<path class="st0" d="M9,633.9v-330c0-45.6,27.9-82.5,62.3-82.5h660.2c34.4,0,62.3,37,62.3,82.5V634c0,45.6-27.9,82.5-62.3,82.5H71.3
						C36.9,716.5,9,679.6,9,633.9z"/>
					<g id="Green_Light">
						<circle class="st1" cx="206.8" cy="501.8" r="134.9"/>
						<path class="st2" d="M112.7,513.7c-11.5-3.6-14.6-43.9,12.3-76.1c40-48.2,97.7-47,103.8-21.3c8.5,35.9-36.9,21.7-71.5,50.7
							C135.7,485,130.9,519.3,112.7,513.7L112.7,513.7z"/>
						<path class="st3" d="M60.8,436.5c-4.7,9.3-19,8.9-17.7-5.2c3.2-34.3,22.7-61.3,38.7-77.8c31.8-33.4,78.5-52.4,125-52.3
							c46.6-0.2,93.2,18.9,125.1,52.2c16,16.5,38.7,53.3,38.8,79c0,11.2-12.7,14.2-17.3,5.1c-11.6-22.5-47.4-96.1-146.6-96.1
							S72.2,414.2,60.8,436.5L60.8,436.5z"/>
					</g>
					<g id="Red_Light">
						<circle class="st4" cx="594.4" cy="501.8" r="134.9"/>
						<path class="st5" d="M500.3,513.8c-11.5-3.6-14.6-43.9,12.3-76.1c40-48.2,97.7-47,103.8-21.3c8.5,35.9-36.9,21.7-71.5,50.7
							C523.2,485.1,518.5,519.4,500.3,513.8z"/>
						<path class="st3" d="M448.3,436.5c-4.7,9.3-19,8.9-17.7-5.2c3.2-34.3,22.7-61.3,38.7-77.8c31.8-33.4,78.5-52.4,125-52.3
							c46.6-0.2,93.2,18.9,125.1,52.2c16,16.5,38.7,53.3,38.8,79c0,11.2-12.7,14.2-17.3,5.1c-11.6-22.5-47.4-96.1-146.6-96.1
							S459.8,414.2,448.3,436.5L448.3,436.5z"/>
					</g>
				</svg>
				</div>
			</div>
