!function(e, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define("customProtocolCheck", [], n) : "object" == typeof exports ? exports.customProtocolCheck = n() : e.customProtocolCheck = n()
}(window, (function() {
    return function(e) {
        var n = {};
        function t(o) {
    ...
    , function(e, n) {
        var t, o = {
            ...
            userAgentContains: function(e) {
                ...
                this.getUserAgent().toLowerCase().indexOf(e) > -1
            },
            isOSX: function() {
            ...
            ), t), u = window; u.parent && u != u.parent; )
                u = u.parent;
            onBlur = function() {
                clearTimeout(i),
                c.remove(),
            ...
            try {
                o.contentWindow.location.href = e,
                t()
            } catch (e) {
            ...
            var e, n = window.navigator.userAgent, t = n.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
            return /trident/i.test(t[1]) ? (e = /\brv[ :]+(\d+)/g.exec(n) || [],
            parseFloat(e[1]) || "") : "Chrome" === t[1] && null != (e = n.match(/\b(OPR|Edge)\/(\d+)/)) ? parseFloat(e[2]) : (t = t[2] ? [t[1], t[2]] : [window.navigator.appName, window.navigator.appVersion, "-?"],
        ...
        e.exports = function(e, n, i) {
            var d = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 2e3
              ...
              , g = function() {
                o.isFirefox() ? s() >= 64 ? u(e, m, v) : a(e, m, v) : o.isChrome() ? c(e, m, v) : o.isOSX() ? u(e, m, v) : p()
            };
            if (d && (t = d),
            o.isEdge() || o.isIE())
                f(e, n, i);
