...
function registeredScripts() {
    ...
    */
    scripts.push({ id: 'doorsapi2', path: '/doorsapi2.mjs', version: 398 });
    scripts.push({ id: 'generic6', path: '/client/generic6.js', version: 393 });
    ...
    scripts.push({ id: 'doorsapi2', path: '/doorsapi2.mjs', version: 382 });
