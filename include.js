        ...
        if (Array.isArray(arguments[0])) {
            ...
            if (script && script.aliasOf) {
                ...
                if (typeof arguments[1] == 'string') {
                    // Si tiene http / .js / .mjs / .css es el src, sino el branch
                    if (arguments[1].indexOf('http') >= 0 || arguments[1].indexOf('.js') >= 0 || arguments[1].indexOf('.mjs') >= 0 || arguments[1].indexOf('.css') >= 0) {
                        pSrc = arguments[1];
                    } else {
                        pVer = arguments[1]
                    }
