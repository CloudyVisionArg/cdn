...
function registeredScripts() {
	...
	scripts.push({ id: 'app7-console', path: '/app7/console.html', version: 0 });
	scripts.push({ id: 'app7-chpass', path: '/app7/chpass.html', version: 0 });
	scripts.push({ id: 'app7-login', path: '/app7/login.html', version: 0 });
