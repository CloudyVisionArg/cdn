...
function registeredScripts() {
    ...
    */
    ...
    scripts.push({ id: 'web-generic', path: '/web/generic.js', version: 279 });
    scripts.push({ id: 'app7-generic', path: '/app7/generic.js', version: 279 });
	scripts.push({ id: 'web-controls', path: '/web/controls.js', version: 279 });
    /*
    ...
    */
    ...
    scripts.push({ id: 'doorsapi2', path: '/doorsapi2.mjs', version: 278 });
