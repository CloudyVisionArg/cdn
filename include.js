...
function registeredScripts() {
    ...
    */
    ...
    scripts.push({ id: 'doorsapi2', path: '/doorsapi2.mjs', version: 289 });
    scripts.push({ id: 'web-generic', path: '/web/generic.js', version: 289 });
    scripts.push({ id: 'app7-generic', path: '/app7/generic.js', version: 289 });
    /*
    scripts.push({ id: 'app7-generic', path: '/app7/generic.js', version: 280 });
    scripts.push({ id: 'web-generic', path: '/web/generic.js', version: 280 });
