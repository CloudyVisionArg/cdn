...
(async () => {
    ...
    var arrScriptTemp = [];
    arrScriptTemp.push({id: 'monaco-editor-loader', depends: ['monaco-editor', 'monaco-editor-nls'], src: 'https://cdnjs.cloudflare.com/ajax/libs/monaco-editor/0.30.0/min/vs/loader.js' });
